...
| Behaviour | Status | Where |
|---|---|---|
| The store syncs through the CloudKit private database | Implemented | `DatesModelContainer.makeContainer` passes `.private("iCloud.com.moorelabs.Dates")`; entitlement in `project.yml` |
